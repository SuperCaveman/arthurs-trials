...
public class GameLiftServerSDK : ModuleRules
{
    public GameLiftServerSDK(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        else if (Target.Platform == UnrealTargetPlatform.Linux || Target.Platform == UnrealTargetPlatform.LinuxArm64)
        {
            ...
            // The bundled spdlog/fmt release predates clang 20. Its C++20
            // consteval format-string path fails while compiling the metrics
            // module under UE 5.8's v26 Linux toolchain. Keep compile-time
            // formatting otherwise intact, but use fmt's compatible
            // non-consteval construction path for the Linux server artifact.
            PublicDefinitions.Add("FMT_CONSTEVAL=");
        }
