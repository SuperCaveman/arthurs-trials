...
assert.match(dockerfile, /CMD \["node", "src\/sqs-consumer\.mjs"\]/);

console.log('Verified: the results worker container runs as non-root with a locked production dependency install.');
